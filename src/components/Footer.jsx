...
function Footer() {
    const iconsClass = "transition ease-in-out opacity-50 hover:opacity-100 hover:scale-110 fill-stone-900 dark:fill-stone-200 w-6 h-6 cursor-pointer"
    const github = (
        <svg 
    ...
    return (
        <div className="flex flex-col md:flex-row py-5 items-center justify-center md:justify-around w-full">
            <p className="text-sm opacity-50">
                &copy; {new Date().getFullYear} Made with &#10084; by Ali Bardide.
            </p>
            <div className="flex flex-row mt-2 md:mt-0 gap-2">
