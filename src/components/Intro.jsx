...
function Intro() {
    const iconsClass = "transition ease-in-out opacity-50 hover:opacity-100 hover:scale-110 fill-stone-900 dark:fill-stone-200 w-8 h-8 cursor-pointer"
    const github = (
        <svg 
    ...
    const youtube = (
        ...
        class={iconsClass} viewBox="0 0 24 24">
