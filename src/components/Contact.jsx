    ...
    return (
        <div className="flex flex-col mb-10 mx-auto">
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/paoxgwvb" method="post" className="flex flex-col w-full md:w-7/12 justify-end">
                    <Title>Contact</Title>
                    ...
                    <button type="button" className="text-center justify-end inline-block px-8 py-3 w-max text-base font-medium rounded-md text-white bg-blue-500 drop-shadow-md hover:stroke-white transition ease-in-out hover:bg-violet-500 hover:scale-110 justify-end">Work With Me</button>
                </form>
            </div>
        </div>
    )
