    ...
    return (
        <ol className="flex flex-col md:flex-row relative border-l border-stone-200 dark:border-stone-700">
            <li className="mb-10 ml-4 group">
                <div className="absolute transition duration-200 w-3 h-3 group-hover:bg-purple-700 bg-stone-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-stone-900 dark:bg-stone-700" />
                <p className="flex flex-wrap gap-4 fex-row items-center justify-start text-xs md:text-sm">
