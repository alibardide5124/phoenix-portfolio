...
function PortfolioItem({ title, imgUrl, stack, link }) {
    return (
        <a href={link} target='_blank' rel="noopener noreferrer" className="flex flex-row md:flex-col bg-stone-100 dark:bg-stone-800 rounded-md items-center justify-between overflow-hidden">
            <img src={imgUrl} alt="portfolio" className="w-1/3 md:w-full h-36 md:h-48 object-cover rounded-md cursor-pointer"/>
            <div className="w-3/4 md:w-full p-4">
